...
{
    class PieceX: PieceParent, ITetronimo
    {
        
        public override Grid _tetrisGrid {  get; set; }
        public PieceX(Grid TetrisBoard) 
        ...
        public override void InitializePosition1()
        {
            ...
            Shape[0] = CreateRectangle(_tetrisGrid, PosX, PosY, Colors.Yellow);
            Shape[1] = CreateRectangle(_tetrisGrid, PosX +1, PosY, Colors.Yellow);
            Shape[2] = CreateRectangle(_tetrisGrid, PosX , PosY +1, Colors.Yellow);
            Shape[3] = CreateRectangle(_tetrisGrid, PosX +1, PosY +1, Colors.Yellow);
