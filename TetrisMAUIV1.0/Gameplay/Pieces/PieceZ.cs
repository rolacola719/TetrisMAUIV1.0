...
{
    class PieceZ: PieceParent, ITetronimo
    {
       
        public override Grid _tetrisGrid {  get; set; }
        public PieceZ(Grid TetrisBoard) 
        ...
        public override void InitializePosition1()
        {
            ...
            Shape[0] = CreateRectangle(_tetrisGrid, PosX, PosY, Colors.Red);
            Shape[1] = CreateRectangle(_tetrisGrid, PosX -1, PosY, Colors.Red);
            Shape[2] = CreateRectangle(_tetrisGrid, PosX , PosY +1, Colors.Red);
            Shape[3] = CreateRectangle(_tetrisGrid, PosX +1, PosY +1, Colors.Red);
