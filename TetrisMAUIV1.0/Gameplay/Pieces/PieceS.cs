...
{
    class PieceS: PieceParent, ITetronimo
    {

        public override Grid _tetrisGrid {  get; set; }
        public PieceS(Grid TetrisBoard) 
        ...
        public override void InitializePosition1()
        {
            ...
            Shape[0] = CreateRectangle(_tetrisGrid, PosX, PosY, Colors.Green);
            Shape[1] = CreateRectangle(_tetrisGrid, PosX -1, PosY, Colors.Green);
            Shape[2] = CreateRectangle(_tetrisGrid, PosX , PosY -1, Colors.Green);
            Shape[3] = CreateRectangle(_tetrisGrid, PosX +1, PosY -1, Colors.Green);
        ...
        public override void InitializePosition2()
        {
            ...
            Shape[0] = CreateRectangle(_tetrisGrid, PosX, PosY, Colors.Green);
            Shape[1] = CreateRectangle(_tetrisGrid, PosX + 1, PosY, Colors.Green);
            Shape[2] = CreateRectangle(_tetrisGrid, PosX + 1, PosY + 1, Colors.Green);
            Shape[3] = CreateRectangle(_tetrisGrid, PosX, PosY - 1, Colors.Green);
